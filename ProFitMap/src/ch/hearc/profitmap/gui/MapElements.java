...
public class MapElements
{
	...
	public MarkerOptions mo = new MarkerOptions().position(NEUCH_LOC).snippet("Tits!").title("Prout!");
	// public Map<Marker,MarkerOptions> markerMap;
	public List<MarkerOptions> moList;

	public PolylineOptions plo = new PolylineOptions().geodesic(true).color(Color.parseColor("#AA66CC"));
	public Polyline pl;
